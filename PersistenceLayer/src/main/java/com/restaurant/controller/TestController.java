...
public class TestController {
    ...
    public Product addOrUpdateProduct(){
        return productService.writeOrUpdateProduct(new Product("product" + counter++, "businessKey" + counter++));
    }

    @RequestMapping(value = "/role", method = RequestMethod.GET)
    public Role addOrUpdateRole(){
        return userService.writeRole(new Role(("role" + Integer.toString(counter++)), Integer.toString(counter++)));
    }
}
